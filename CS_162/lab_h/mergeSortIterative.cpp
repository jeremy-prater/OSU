...
void mergeSortIterate::mergeSort()
{
  DebugConsole::debug_print (0, true, COLOR_CYAN, "Starting mergesort Iterate... %d items\n\n", bufferSize);
  SortTimer myTimer;
  myTimer.Start();
  merge_sort(buffer, bufferSize);
  myTimer.Stop();
...
void mergeSortIterate::merge(int arr[], int l, int m, int r)
{
    int i, j, k;
    int n1 = m - l + 1;
    int n2 =  r - m;
