...
//
//
// Project 7A static class variables
//
//
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
Animate()
{
	...
	status = clEnqueueAcquireGLObjects(CmdQueue, 1, &CLParticlePosition, 0, NULL, NULL);
	PrintCLError(status, "clEnqueueAcquireGLObjects (1): ");
	status = clEnqueueAcquireGLObjects(CmdQueue, 1, &CLParticleColor, 0, NULL, NULL);
	...
	status = clEnqueueReleaseGLObjects(CmdQueue, 1, &CLParticleColor, 0, NULL, NULL);
	PrintCLError(status, "clEnqueueReleaseGLObjects (2): ");
	status = clEnqueueReleaseGLObjects(CmdQueue, 1, &CLParticlePosition, 0, NULL, NULL);
	PrintCLError(status, "clEnqueueReleaseGLObjects (2): ");
	Wait(CmdQueue);
	clFinish(CmdQueue);
...
InitCL()
{
	...
	GLParticleVelocity = new struct xyzw [NUM_PARTICLES];
